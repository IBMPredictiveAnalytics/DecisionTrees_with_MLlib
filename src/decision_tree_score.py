script_details = ("decision_tree_score.py",0.5)
...
# check input data model, create a DataModelTools to handle data model and data conversions
...
model = DecisionTreeModel.load(sc, modelpath)
...
if isinstance(datamodel[target],list):
